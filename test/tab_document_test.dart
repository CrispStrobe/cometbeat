...
void main() {
  ...
  group('E1 — rich GPIF export', () {
    test('a rich tab exports its techniques as GPIF note properties', () {
      ...
      expect(gpif, contains('LetRing'));
      expect(gpif, contains('Tapped'));
      expect(gpif, contains('RightHandFinger'));
      expect(gpif, contains('LeftHandFinger'));
      expect(gpif, contains('Bended'));
      // …and the whole thing still writes a valid .gp (PK zip header).
      final bytes = writeGpFromGpif(gpif);
