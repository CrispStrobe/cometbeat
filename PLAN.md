...
> **Swept 2026-08-01:** every ✅ entry was moved out of this file and out of
> `docs/PLAN.md` into `docs/HISTORY.md`, along with the shipped "Modes & games"
> and Songbook catalogues. **This file is now pending work only** — if you are
> looking for how something already-built came out, or for the reasoning behind
> a shipped decision, it is in HISTORY. 46 ⬜ cards remain.
...
✅ **Complete** — every card in this phase shipped; the entries are in [docs/HISTORY.md](docs/HISTORY.md).
