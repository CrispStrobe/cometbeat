...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get workshopPlayingState => 'Spielweise';
  ...
  String workshopPlayBelowRange(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Noten unter dem Tonumfang',
      one: '1 Note unter dem Tonumfang',
    );
    return '$_temp0';
  }
  ...
  String workshopPlayAboveRange(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Noten über dem Tonumfang',
      one: '1 Note über dem Tonumfang',
    );
    return '$_temp0';
  }
  ...
  String workshopPlayOutOfReach(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count Noten über diesem Niveau',
      one: '1 Note über diesem Niveau',
    );
    return '$_temp0';
  }
  ...
  @override
  String get trayPutSample => 'Sample in die Zwischenablage';
  ...
  String get projectNone =>
      'Noch keine gespeicherten Projekte — speichere dieses, um es zu behalten.';

  @override
  String get projectRenameFailed => 'Dieser Name ist schon vergeben';

  @override
  String projectOpenConfirm(String name) {
    return '„$name“ öffnen? Was gerade geladen ist, wird ersetzt.';
  }
  ...
  String projectOpenFailed(String name) {
    return '„$name“ konnten wir nicht öffnen';
  }

  @override
  String get loopMixerCopyPattern => 'Muster kopieren';

  @override
  String get loopMixerCopyPatternHint =>
      'tippen, um das Muster dieser Spur auf eine andere zu legen';

  @override
  String loopMixerCopyPatternTo(String name) {
    return '$name kopieren auf…';
  }

  @override
  String loopMixerCopiedPattern(String from, String to) {
    return '$from auf $to kopiert';
  }

  @override
  String get loopMixerAddAudio => 'Loop importieren';

  @override
  String get loopMixerAddAudioHint =>
      'einen aufgenommenen Loop aus einer Datei holen — er wird auf den Groove gedehnt';
  ...
  String get loopMixerAudioImportFailed =>
      'Diese Audiodatei konnten wir nicht lesen';

  @override
  String loopMixerAudioStretched(String name, String percent) {
    return '$name wurde um $percent% gedehnt, um in den Groove zu passen';
  }
  ...
  @override
  String get drumkitDone => 'Fertig — zurück ans Loop Studio';

  @override
  String get loopMixerEditDrumsInKit =>
      'Drums auf den Drum-Kit-Pads bearbeiten';
  ...
  @override
  String get licenseCannotExport => 'Export nicht möglich';

  @override
  String get licenseTermsTitle => 'Lizenzbedingungen';

  @override
  String get licenseCannotInclude => 'Kann nicht enthalten sein';

  @override
  String get licenseAgreeAndExport => 'Zustimmen und exportieren';
  ...
  @override
  String get tabRig => 'Gitarren-Setup';

  @override
  String get tabRigNone => 'Clean (ohne Effekte)';

  @override
  String get tabRigHint =>
      'Effekte nur für diese Spur — die Begleitung kann verzerren, während die Melodie fuzzt.';
  ...
  @override
  String get tabExportPdf => 'PDF (Druck)';
  ...
  @override
  String get trackerZoneInstrument => 'Zonen-Instrument';

  @override
  String get trackerZoneReplaceInstrument => 'Ersetzen';

  @override
  String get trackerZoneInstrumentPickerTitle => 'Instrument der Zone zuweisen';

  @override
  String get trackerZoneVelocityRange => 'Velocity-Bereich';

  @override
  String get trackerZoneVelocityFull => 'Ganzer Bereich (alle Velocities)';

  @override
  String get trackerZoneProcedural => 'Diese Zone ist prozedural';

  @override
  String get trackerZoneProceduralHint =>
      'Mit „Ersetzen“ ein Sample oder eine andere Stimme zuweisen.';
  ...
  @override
  String get highwayInstrumentDrums => 'Schlagzeug';

  @override
  String get gameBeatHighway => 'Beat-Bahn';
  ...
  @override
  String get trayPutSong => 'Song auf die Ablage legen';
