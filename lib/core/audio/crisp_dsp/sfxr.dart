  ...
  SfxrParams copyWith({
    ...
    double? lfoSpeed,
      ...
      SfxrParams(
        ...
        freqRamp: freqRamp ?? this.freqRamp,
        vibStrength: vibStrength ?? this.vibStrength,
        vibSpeed: vibSpeed ?? this.vibSpeed,
        arpMod: arpMod ?? this.arpMod,
        arpSpeed: arpSpeed ?? this.arpSpeed,
        duty: duty ?? this.duty,
        dutyRamp: dutyRamp ?? this.dutyRamp,
        repeatSpeed: repeatSpeed ?? this.repeatSpeed,
        lpfFreq: lpfFreq ?? this.lpfFreq,
        hpfFreq: hpfFreq ?? this.hpfFreq,
        subBass: subBass ?? this.subBass,
        distortion: distortion ?? this.distortion,
        bitCrush: bitCrush ?? this.bitCrush,
        soundVol: soundVol ?? this.soundVol,
        fmDepth: fmDepth ?? this.fmDepth,
